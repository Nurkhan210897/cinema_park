<template>
  <div class="wrapper">
    <div class="content-wrapper auth">
      <section>
        <h1 class="ui-title-1">Регистрация</h1>
        <form action="" @submit.prevent="onSubmit">
          <div class="form_item">
            ...
            <div class="form_input_item">
              ...
              />
              <small
                v-if="$v.repeatPassword.$dirty && !$v.password.required"
                class="form_error"
            ...
            <div class="form_input_item">
              <input
                ...
                :class="{ form_error: $v.repeatPassword.$error }"
    ...
    onSubmit() {
      ...
      if (this.$v.$invalid) {
        ...
        this.$store
          ...
          .catch((err) => {
            this.submitStatus = 'E-mail уже зарегестрирован';
